package com.isa.platform.u202220659.inventory.interfaces.rest;
...
import com.isa.platform.u202220659.inventory.interfaces.rest.transform.CreateProductCommandFromResourceAssembler;
import com.isa.platform.u202220659.inventory.interfaces.rest.transform.ProductResourceFromEntityAssembler;
...
public class ProductsController {
    ...
    public ResponseEntity<ProductResource> getProductById(@PathVariable Long productId){
        var getProductByIdQuery = new GetProductByIdQuery(Math.toIntExact(productId));
